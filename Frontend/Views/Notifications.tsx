...
import rustyles, { snips } from "../Styles/rustyles";
...
const NotificationIconContainer = styled.div`
  ...
  height: ${NOTIF_SIZE};
  border-radius: 8px;
  border: 1px solid ${rustyles.colors.text};
  background: ${({ color }) => color || rustyles.colors.backgroundlighter};
  overflow: hidden;
  display: flex;
  flex-grow: 0;
  flex-shrink: 0;
