...
import { Generic, TxDeclined } from "../Components/Icons";
...
class NotificationManager extends EventEmitter {
  ...
  balanceEmpty(): void {
    this.notify(
      ...
      <span>
        Your Chain account is out of balance!
        <br />
  ...
  txExecuteError(failureReason: string) {
    this.notify(
      NotificationType.TxInitError,
      <span>Execute contract failed. Reason: {failureReason}</span>
    );
  }
}
